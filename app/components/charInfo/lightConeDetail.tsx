import LightCone from "@/app/Types/LightCone"
        ...
        <div className="flex gap-12"> 
            ...
            <div className="min-w-[220px] pt-10 w-[300px]">
                <div>
                    ...
                    <p className="my-2" >Nv. <span>{props?.lightCone?.level}/<span className="text-gray-400">{Math.ceil(props?.lightCone?.level! / 10) * 10}</span></span> </p>
